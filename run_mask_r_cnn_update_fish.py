...
train_dataset=FishRCNNDataset(annotations_file="data/Fish_Dataset/train/_annotations.coco.json",
                                       img_dir="data/Fish_Dataset/train",
...
validation_dataset=FishRCNNDataset(annotations_file="data/Fish_Dataset/valid/_annotations.coco.json",
                                            img_dir="data/Fish_Dataset/valid",
                                            transforms=data_transforms_validation)
#validation_dataset = torch.utils.data.Subset(validation_dataset, range(0, 1, 1))


test_dataset=FishRCNNDataset(annotations_file="data/Fish_Dataset/test/_annotations.coco.json",
                                            img_dir="data/Fish_Dataset/test",
                                            transforms=data_transforms_validation)
